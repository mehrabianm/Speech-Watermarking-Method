...
R = {'wav-file/new_new/1.wav'};

W = {'wav-file/watermark/w.wav'};

E = {'wav-file/extract/e.wav'};
...
fnl = finalExt_20azar(wav, wtk, counterFig, extFile, lenFramNum, timer_embed_watermark_gen_finished, embed_wtk, Fn);
